    ...
    return (
        <div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 w-11/12 mx-auto">
               ...
               <div className='text-center p-6 shadow-lg my-8'>
                    ...
                    <Link to='/my-queries'><button className='bg-[#EF4444] text-white    rounded-sm font-semibold my-4 px-4 py-2' >My Query</button></Link>
                </div>
                ...
                <div className='text-center p-6 shadow-lg my-8'>
                    ...
                    <Link to='/queries'><button className='bg-gray-900 text-white rounded-sm font-semibold my-4 px-4 py-2' > Searh Query</button></Link>            
                    </div>
                </Zoom>
                {/* card 3  */}
                <Zoom triggerOnce={false}>
                <div className='text-center p-6 shadow-lg my-8'>
                    ...
                    <Link to='/My-recommendations'><button className='bg-[#EF4444] text-white rounded-sm font-semibold my-4 px-4 py-2' >My Anwers</button></Link>
                </div>
                </Zoom>
            </div>
        </div>
