        ...
        <div>
            ...
            <div className="grid md:grid-cols-2 w-11/12  md:w-9/12 mx-auto my-16">
                ...
                <div className="bg-gray-900 pl-8 pr-4 py-16 text-white">
                    ...
                    <p className="text-gray-400 py-2">Need expert guidance? Connect with industry professionals who can provide reliable advice, answer your questions, and help you solve problems efficiently. Whether it's career advice, technical support, or personal growth, get the insights you need from experienced professionals in various fields. Start learning and growing today!</p>
