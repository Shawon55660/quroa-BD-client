    ...
    return (
      ...
      <div className="relative w-full h-[600px] bg-cover transition-all duration-1000 ease-in-out transform hover:scale-105"
        ...
        <div className="relative z-10 max-w-2xl text-white py-32 px-6">
          ...
          <p className="text-xl sm:text-xl md:text-xl mb-8  text-gray-900 opacity-85 animate__animated animate__fadeIn animate__delay-2s">
      ...
      <div className="relative w-full h-[600px] bg-cover  transition-all duration-1000 ease-in-out transform hover:scale-105"
        ...
        <div className="relative z-10 max-w-2xl text-[#fa4747] py-32 px-12  ">
          ...
          <p className="text-lg text-black sm:text-xl  md:text-xl mb-8  drop-shadow-md animate__animated animate__fadeIn animate__delay-2s">
            Find answers to your questions, or ask your own! Explore a community of knowledge.
          </p>
          <Link to='/my-queries'><button className="bg-gradient-to-r from-[#fa4748] to-[#fa4747] text-white py-3 px-8 rounded-full text-lg font-semibold hover:from-[#fa4747] hover:to-[#f35757] transform transition-all duration-300 ease-in-out">
            Start Query
          </button></Link>
      ...
      <div className="relative w-full h-[600px] bg-cover  transition-all duration-1000 ease-in-out transform hover:scale-105"
        ...
        <div className="relative z-10 max-w-2xl text-white py-32 lg:ml-6 px-12">
          ...
          <h1 className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-900 mb-6 tracking-tight">
            Welcome to the Q&A <p className='pt-4'>Hub !</p>
          </h1>
          {/* Paragraph */}
          <p className="text-2xl sm:text-xl md:text-xl mb-8  opacity-80">
